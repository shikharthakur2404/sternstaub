...
| `src/components/Solar3D/asteroidBelt.js` | Photorealistic Main Asteroid Belt | 2,800-body multi-archetype asteroid field (elongated potato, contact binary peanut, angular impact shard, cratered chondrite), C/S/M mineral spectra, Kirkwood resonance gap distribution, 1,200 zodiacal debris particles, 3-axis matrix tumbling, and prominent Dwarf Planet Ceres (Occator Crater salt faculae) and Protoplanet Vesta (Rheasilvia impact basin). |
